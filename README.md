...
<body class="bg-tactical-900 text-gray-100 antialiased selection:bg-amber-500 selection:text-black overflow-x-hidden">
    ...
    <section id="como-funciona" class="py-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-tactical-800">
        <div class="bg-tactical-800/60 border border-tactical-700/80 rounded-2xl p-6 sm:p-10 shadow-xl">
            ...
            <!-- Interactive Component Tabs (grid-cols-2 sm:grid-cols-3 gap-2) -->
    ...
    <section id="realmente-funciona" class="py-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-tactical-800">
        <div class="bg-tactical-800/60 border border-tactical-700/80 rounded-2xl p-6 sm:p-10 shadow-xl">
            ...
            <!-- INTERACTIVE SIMULATOR: IGD CALCULATOR & SOFTWARE VETO CLAUSE (p-4) -->
            <div class="bg-tactical-900/90 rounded-2xl p-4 border border-amber-500/40 glow-amber">
                <div class="flex flex-col gap-2 border-b border-tactical-700 pb-3 mb-4">
                    <h3 class="font-bold text-white text-sm flex items-start gap-2 leading-tight">
    ...
    <section id="diferencias" class="py-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-tactical-800">
        <div class="bg-tactical-800/60 border border-tactical-700/80 rounded-2xl p-6 sm:p-10 shadow-xl">
            ...
            <!-- Detailed Comparison Blocks (Vertical stack for full mobile width and perfect readability) -->
            <div class="space-y-3">
                ...
                <div class="bg-tactical-900/70 rounded-xl border border-tactical-700 p-4">
                    <h4 class="text-xs font-black uppercase text-amber-400 mb-2">Control de Fatiga</h4>
                    <div class="space-y-2 text-[11px] leading-relaxed">
                        <div>
                            <span class="font-bold text-gray-400">Metodologías Tradicionales:</span>
                            <span class="text-gray-300"> Acumulación de fatiga metabólica y "sufrir la serie". Genera volumen basura.</span>
                        </div>
                        <div>
                            <span class="font-bold text-amber-300">Codex Bellator – Ars Unified:</span>
                            <span class="text-gray-300"> Regla del 10% UVC (Umbral de Velocidad Crítica). Aborto automático de serie.</span>
                        </div>
                    </div>
                </div>

                <div class="bg-tactical-900/70 rounded-xl border border-tactical-700 p-4">
                    <h4 class="text-xs font-black uppercase text-amber-400 mb-2">Evaluación</h4>
                    <div class="space-y-2 text-[11px] leading-relaxed">
                        <div>
                            <span class="font-bold text-gray-400">Metodologías Tradicionales:</span>
                            <span class="text-gray-300"> Criterio subjetivo del entrenador ("se ve bien") y notas de texto libre.</span>
                        </div>
                        <div>
                            <span class="font-bold text-amber-300">Codex Bellator – Ars Unified:</span>
                            <span class="text-gray-300"> Telemetría S.M.V. ($IGD$, $I.I.S.$, $I.P.F.$) e IA-P1 adaptativa por algoritmos.</span>
                        </div>
                    </div>
                </div>

                <div class="bg-tactical-900/70 rounded-xl border border-tactical-700 p-4">
                    <h4 class="text-xs font-black uppercase text-amber-400 mb-2">Reclutamiento Motor</h4>
                    <div class="space-y-2 text-[11px] leading-relaxed">
                        <div>
                            <span class="font-bold text-gray-400">Metodologías Tradicionales:</span>
                            <span class="text-gray-300"> Henneman convencional (activa primero Fibras Lentas Tipo I).</span>
                        </div>
                        <div>
                            <span class="font-bold text-amber-300">Codex Bellator – Ars Unified:</span>
                            <span class="text-gray-300"> Henneman Modificado: Intención Absoluta y Rate Coding (Fibras IIa y IIx).</span>
                        </div>
                    </div>
                </div>

                <div class="bg-tactical-900/70 rounded-xl border border-tactical-700 p-4">
                    <h4 class="text-xs font-black uppercase text-amber-400 mb-2">Estructura del Drill</h4>
                    <div class="space-y-2 text-[11px] leading-relaxed">
                        <div>
                            <span class="font-bold text-gray-400">Metodologías Tradicionales:</span>
                            <span class="text-gray-300"> Repetición ciega de secuencias fijas de 3 pasos sin contexto.</span>
                        </div>
                        <div>
                            <span class="font-bold text-amber-300">Codex Bellator – Ars Unified:</span>
                            <span class="text-gray-300"> Continuidad de Flujo ($A+D+A=1$ como modelo flexible sin pausas pasivas).</span>
                        </div>
                    </div>
                </div>
        ...
        function calculateIGD() {
            ...
            if (st < 5.0 || ste < 5.0) {
                ...
                statusBox.innerHTML = `
                    ...
                    <p class="text-[10px] leading-relaxed text-center">
                        VOTO DE CENSURA ACTIVO: ${st < 5.0 ? 'Software Técnico' : 'Software Táctico'} < 5.0 Se veta el avance a una nueva campaña independientemente de las notas de Hardware.
                    </p>
                `;
            } else if (igdRaw >= 8.0) {
                ...
                statusBox.className = "p-3 rounded-xl border mt-4 transition-all bg-amber-500/20 border-amber-500 text-amber-300 w-full max-w-none text-center";
                statusBox.innerHTML = `
                    <div class="font-black text-[10px] uppercase flex items-center justify-center gap-1 mb-1 text-center leading-tight">
