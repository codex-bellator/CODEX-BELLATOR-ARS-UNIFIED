...
<body class="bg-tactical-900 text-gray-100 antialiased selection:bg-amber-500 selection:text-black overflow-x-hidden">
            ...
            <div class="bg-tactical-900/90 rounded-2xl p-6 border border-amber-500/40 glow-amber">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-tactical-800 p-6 rounded-xl border border-tactical-700 flex flex-col justify-between text-center">
                        ...
                        <div id="status-box" class="p-3 sm:p-4 rounded-xl border mt-4 transition-all bg-red-500/20 border-red-500 text-red-300 w-full max-w-none text-center">
                            <div class="font-black text-[10px] sm:text-xs uppercase flex items-center justify-center gap-1 mb-1 text-center">
                                <i class="fa-solid fa-ban"></i> PROGRESIÓN BLOQUEADA
                            </div>
                            <p class="text-[10px] sm:text-xs leading-relaxed text-center">
    ...
    <script>
        ...
        function calculateIGD() {
            ...
            if (st < 5.0 || ste < 5.0) {
                statusBox.className = "p-3 sm:p-4 rounded-xl border mt-4 transition-all bg-red-500/20 border-red-500 text-red-300 w-full max-w-none text-center";
                statusBox.innerHTML = `
                    <div class="font-black text-[10px] sm:text-xs uppercase flex items-center justify-center gap-1 mb-1 text-center">
                ...
                statusBox.className = "p-3 sm:p-4 rounded-xl border mt-4 transition-all bg-emerald-500/20 border-emerald-500 text-emerald-300 w-full max-w-none text-center";
                statusBox.innerHTML = `
                    <div class="font-black text-[10px] sm:text-xs uppercase flex items-center justify-center gap-1 mb-1 text-center">
                ...
                statusBox.className = "p-3 sm:p-4 rounded-xl border mt-4 transition-all bg-amber-500/20 border-amber-500 text-amber-300 w-full max-w-none text-center";
                statusBox.innerHTML = `
                    <div class="font-black text-[10px] sm:text-xs uppercase flex items-center justify-center gap-1 mb-1 text-center">
