                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-tactical-800 p-6 rounded-xl border border-tactical-700 flex flex-col justify-between text-center">
                        ...
                        <div id="status-box" class="p-4 rounded-xl border mt-4 transition-all bg-red-500/20 border-red-500 text-red-300">
                            <div class="font-black text-xs sm:text-sm uppercase flex flex-wrap items-center justify-center gap-2 mb-1 text-center">
                                <i class="fa-solid fa-ban"></i> PROGRESIÓN BLOQUEADA (VOTO DE CENSURA)
                            </div>
                            <p class="text-xs leading-relaxed break-words">
                                Cláusula de Voto de Censura de Software Activa: Software Técnico &lt; 5.0. Se veta el avance a una nueva campaña independientemente de las notas de Hardware.
                            </p>
                        </div>
                    </div>
                </div>
